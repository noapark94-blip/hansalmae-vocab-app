...
game={...game,status:'finished',winner:'me',hostScore:10,hostMs:42000,review:[{word:'word',meaning:'뜻',example:'Example',translation:'예문',correct:false}]};await w.hsmOpenFriendBattle_();assert(d.querySelector('.fb-result').textContent.includes('멋진 승리'));assert(d.querySelector('.fb-result-stats').textContent.includes('/ 30'));assert(d.querySelector('.fb-review').textContent.includes('Example'));await click('[data-action="exit"]');assert(d.getElementById('fbSearch'));
