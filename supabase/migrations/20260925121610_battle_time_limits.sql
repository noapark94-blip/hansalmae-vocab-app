-- Legacy rooms default to ten seconds; clients cannot set arbitrary deadlines.
alter table public.word_battles add constraint word_battles_seconds_check check (coalesce((settings->>'seconds')::integer,10) in (10,15,20));
