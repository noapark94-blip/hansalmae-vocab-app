const BUILD_VERSION = new URL(self.location.href).searchParams.get('v') || '20260926-172';
...
const REQUIRED_ASSETS = [
  ...
  versioned('./battle-rooms.css'),
  versioned('./home-refresh.css'),
  versioned('./teacher-workspace.css'),
  versioned('./login-polish.css'),
  versioned('./login-polish.js'),
  versioned('./signup-polish.css'),
  versioned('./tablet-layout.css'),
  versioned('./desktop-layout.css'),
  versioned('./wide-bottom-nav.css'),
  ...
  './',
  './index.html',
  versioned('./test-setup.js'),
  versioned('./wrong-review.js'),
  versioned('./wrong-review.css'),
  versioned('./test-setup.css'),
  versioned('./vocab-polish.css'),
  versioned('./student-ui.css'),
  './design-v1.css',
  './design-v2-mobile-nav.css',
  './design-v3-test-rewards.css',
  './ui-icons.css',
  versioned('./ui-icons.js'),
  './teacher-modern.css',
  './fonts/PretendardVariable.woff2',
  './manifest.json',
  versioned('./config.js'),
  versioned('./school-runtime.js'),
