(function improveSchoolVocabTeacherUi(){
  ...
  function addStyles(){
    ...
    s.textContent=[
      '#hsmSchoolVocabTeacherPanel,#hsmSchoolVocabTeacherPanel *{box-sizing:border-box}',
      '#hsmSchoolVocabTeacherPanel{max-width:100%;overflow-x:hidden}',
      '#hsmSchoolVocabTeacherPanel .hsm-sv-grid,#hsmSchoolVocabTeacherPanel .hsm-sv-card,#hsmSchoolVocabTeacherPanel .hsm-sv-field{min-width:0;max-width:100%}',
      '.hsm-sv-excel-guide{width:100%;max-width:100%;min-width:0;margin:12px 0 18px;border:1px solid #eadbe4;border-radius:16px;background:#fffafd;overflow:hidden}',
      '.hsm-sv-excel-guide summary{cursor:pointer;list-style:none;padding:15px 16px;font-weight:900;color:#8f145f;font-size:15px;display:flex;justify-content:space-between;align-items:center;gap:12px;min-width:0}',
      '.hsm-sv-excel-guide summary::-webkit-details-marker{display:none}',
      '.hsm-sv-excel-guide summary:after{content:"+";font-size:22px;line-height:1;flex:0 0 auto}',
      '.hsm-sv-excel-guide[open] summary:after{content:"−"}',
      '.hsm-sv-guide-body{min-width:0;max-width:100%;padding:0 16px 16px;color:#67606a;font-size:13px;line-height:1.65;overflow:hidden;word-break:keep-all}',
      '.hsm-sv-guide-table-wrap{width:100%;max-width:100%;min-width:0;overflow-x:auto;-webkit-overflow-scrolling:touch;margin:12px 0;border-radius:12px}',
      '.hsm-sv-guide-table{width:100%;min-width:560px;border-collapse:separate;border-spacing:0;border:1px solid #eadbe4;border-radius:12px;overflow:hidden;background:#fff;table-layout:fixed}',
      '.hsm-sv-guide-table th,.hsm-sv-guide-table td{padding:10px 12px;text-align:left;border-right:1px solid #eadbe4;border-bottom:1px solid #eadbe4;white-space:normal;overflow-wrap:anywhere;vertical-align:top}',
