...
(function loadHansalmaeSchoolVocabulary(){
  ...
  if(/teacher\.html/i.test(location.pathname)){
    ...
    if(!document.querySelector('script[data-hsm-word-cover]')){var cover=document.createElement('script');cover.src='./word-cover.js?v=4';cover.defer=true;cover.dataset.hsmWordCover='1';document.head.appendChild(cover);}
  }
})();