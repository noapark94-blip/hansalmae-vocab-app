...
(function loadHansalmaeSchoolVocabulary(){
  ...
  if(/teacher\.html/i.test(location.pathname)){
    ...
    if(!document.querySelector('script[data-hsm-school-vocab-free-test-ui]')){var freeTestUi=document.createElement('script');freeTestUi.src='./school-vocab-free-test-ui.js?v=1';freeTestUi.defer=true;freeTestUi.dataset.hsmSchoolVocabFreeTestUi='1';document.head.appendChild(freeTestUi);}
