...
(function loadHansalmaeSchoolVocabulary(){
  ...
  if(/teacher\.html/i.test(location.pathname)){
    ...
    if(!document.querySelector('script[data-hsm-school-vocab-selection-fix]')){var selectionFix=document.createElement('script');selectionFix.src='./school-vocab-selection-fix.js?v=1';selectionFix.defer=true;selectionFix.dataset.hsmSchoolVocabSelectionFix='1';document.head.appendChild(selectionFix);}
