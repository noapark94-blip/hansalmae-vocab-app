...
(function loadHansalmaeSchoolVocabulary(){
  ...
  if(/teacher\.html/i.test(location.pathname)){
    ...
    if(!document.querySelector('script[data-hsm-school-vocab-exam-polish]')){var examPolish=document.createElement('script');examPolish.src='./teacher-school-vocab-exam-polish.js?v=1';examPolish.defer=true;examPolish.dataset.hsmSchoolVocabExamPolish='1';document.head.appendChild(examPolish);}
  }else{
